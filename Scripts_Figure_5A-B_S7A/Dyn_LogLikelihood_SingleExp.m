...
function LogLikelihood = Dyn_LogLikelihood_SingleExp(para_current,dyn_sys,time,species_idx,X0,Y_mean,Y_std)
...
% - dyn_sys: simulated dynamical system (function handle)
