...
- "data_fitting" folder: A folder containing co-culture experimental data for parameter inference. 

- "MCMC_seed" folder: A folder containing initial parameters used to generate the MCMC runs to generate the figures in the text. Different initial parameters could be used. 
